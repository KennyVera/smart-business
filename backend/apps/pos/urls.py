...
from .views_catalogo import (
    CatalogoGlobalPosViewSet,
    CatalogoLocalPosViewSet,
    CatalogoPosViewSet,
    CategoriaPosViewSet,
    ClienteViewSet,
)
...
router.register(r"catalogo-local", CatalogoLocalPosViewSet, basename="pos-catalogo-local")
router.register(
    r"catalogo-global",
    CatalogoGlobalPosViewSet,
    basename="pos-catalogo-global",
)
